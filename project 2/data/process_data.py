...
def clean_data(df):
    """
    This function performs dataframe cleaning operations for current use case.
...
def save_data(df, database_filename):
    """create and store pandas dataframe in sqlite db"""
    engine = create_engine(f'sqlite:///{database_filename}')
    
    df.to_sql('disaster_text', engine, index=False, if_exists='replace')      
